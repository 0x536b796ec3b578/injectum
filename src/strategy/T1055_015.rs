//! Implementation of MITRE ATT&CK T1055.015: ListPlanting.
//!
...
/// The strategy implementation for T1055.015 (ListPlanting).
#[derive(Default)]
pub(crate) struct T1055_015;

impl Strategy for T1055_015 {
    ...
    fn execute(
        ...
        let info = Technique::T1055_015.info();
