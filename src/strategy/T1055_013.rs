//! Implementation of MITRE ATT&CK T1055.013: Process Doppelgänging.
//!
...
/// The strategy implementation for T1055.013 (Process Doppelgänging).
#[derive(Default)]
...
impl Strategy for T1055_013 {
    ...
    fn execute(
        ...
        let info = Technique::T1055_013.info();
