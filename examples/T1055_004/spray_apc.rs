...
//! ```sh
//! cargo build --package injectum --example T1055_004_Spray_APC --features "tracing,T1055_004" --release
//! ```
//!
//! ## Usage
//! ```sh
//! ./T1055_004_Spray_APC.exe <PID>
//! ```
...
fn run() -> Result<(), InjectumError> {
    ...
    info!("Technique         : T1055.002 (SprayAPCInjection)");
    info!("------------------------------------------------");
...
fn inject_shellcode(pid: u32) -> Result<(), InjectumError> {
    ...
    let strategy = StrategyType::new(Technique::T1055_004, Some("SprayAPCInjection"));
...
fn print_usage() {
    println!("Usage:");
    println!("  T1055_004_Spray_APC.exe <PID>");
}
